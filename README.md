...
- [docs/dogops/REAL_GO2_PR_TEST_PLAN.md](docs/dogops/REAL_GO2_PR_TEST_PLAN.md) - PR-ready
  validation checklist for the offline, OrbStack web, and real-Go2 test paths.
