...
uv run --no-sync dimos mcp list-tools | rg 'run_mission|go_to|follow_route|stop_route|route_status|scan_zone|read_gauge|check_clearance|detect_blocked_aisle|scan_receiving_manifest|verify_work_order|nav_eval_report'
```
